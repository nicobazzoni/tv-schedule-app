...
export default function ScheduleContainer() {
  ...
  return (
    <div className=" items-center flex flex-col border-t-5 p-2 mb-2 border-b-5 border-red-700 mt-5 w-full "><img src="/fox news logo.png" className='max-w-3xl h-10' alt="Network Logo" />
